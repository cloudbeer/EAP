            ...
            $("#xsubmit").click(function(){
                ...
                $.post("/Z10Returned/EditSave", {
                 ...
                 'Remark' : $Remark.val()
                        ...
                        if(data == 1){
                            Li.isSubmit = true;
                            parent.$.jshowtip("退货单已保存！", "success", 1,null,function(){
    ...
    <div id="contents">
        <div id="top">
            <div class="con clearfix">
                <div class="fl">
                    <a href="javascript:;" class="btn img back" rel="/Z10SaleReturned/SaleReturnedList"><i class="icon i_back"></i>返回<b></b></a>
                </div>
            </div>
        </div>
        <div id="main">
