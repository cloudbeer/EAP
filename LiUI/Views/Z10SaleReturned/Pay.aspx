...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<script src="/Content/Scripts/pages/liwill.salereturned.js" type="text/javascript"></script>
		...
		<div id="main">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" class="detail <% if (ViewData["IsDetail"]!=null){ Response.Write("readonly");}%>">
				...
				<tr>
					...
					<td class="tc">
						<%=Model.Z10Order.DateShip.HasValue ? Model.Z10Order.DateShip.Value.ToString("yyyy年MM月dd日") : "还没有交货"%>
					</td>
					<td width="*">
					</td>
				</tr>
