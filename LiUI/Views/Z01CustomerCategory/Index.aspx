<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master"
 Inherits="System.Web.Mvc.ViewPage<Zippy.Data.Collections.PaginatedList<Z01Beetle.Entity.Z01CustomerCategory>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<script type="text/javascript">
		...
		var controller = "/Z01CustomerCategory";
	...
	<div id="contents">
		...
		<div id="main">
			...
			<table cellspacing="0" cellpadding="0" border="0" rel="main" class="list-table">
				...
				<tr rel="item">
					<td class="tc">
						<input type="checkbox" value="<%=item.CategoryID %>" name='checkID' class="xID" />
					</td>
					<td>
						<%=item.Title%>
					</td>
					...
					<td>
						<a href="/Z01CustomerCategory/Edit?xParentID=<%=item.CategoryID %>&ReturnUrl=<%=System.Web.HttpUtility.UrlEncode(Request.RawUrl) %>"
						...
						<% if (Model.Count(s => s.ParentID == item.CategoryID) > 1)
						   { %>
						<a href='/Z01CustomerCategory/Sort/<%=item.CategoryID %>' class='i_xsort' id='xsort'>
							排序</a>
						<%} %>
					</td>
				</tr>
