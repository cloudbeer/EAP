<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Zippy.Data.Collections.PaginatedList<Z01Beetle.Entity.Z01Title>>" %>
    ...
    <div id="contents">
        ...
        <div id="main">
            ...
            <table cellspacing="0" cellpadding="0" border="0" rel="main" class="list-table">
                ...
                <tr rel="item">
                    <td class="tc">
                        <input type="checkbox" value="<%=item.TitleID %>" name='checkID' class="xID" />
                    </td>
                    <td>
                        <%=item.Title%>
                    </td>
                    ...
                    <td>
                        <a href="javascript:;" rel="<%=item.TitleID %>" class="i_xedit xedit">修改</a>
                        <a href='javascript:;' rel="<%=item.TitleID %>" class="i_xdel xdel">删除</a>
                        <a href='javascript:;' rel="<%=item.TitleID %>" class="i_xdetail xdetail">详情</a>
                    </td>
                </tr>
                <%
                    }
