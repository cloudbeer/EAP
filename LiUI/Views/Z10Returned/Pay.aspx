...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<script src="/Content/Scripts/pages/liwill.returned.js" type="text/javascript"></script>
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" class="detail <% if (ViewData["IsDetail"]!=null){ Response.Write("readonly");}%>">
				...
				<tr class="focus">
					...
					<td class="tc">
						...
						<label class="lradio"><input type="radio" name="action" value="<%=(int)(EAP.Logic.Z10.OrderStatus.Finished | EAP.Logic.Z10.OrderStatus.Paid) %>" /> 产品交易完成，结束单据。</label>
					</td>
					<td></td>
					<td></td>
					<td></td>
