            ...
            $("#xsubmit").click(function(){
                ...
                $.post("/Z10Order/EditSave", {
                 ...
                 'Remark' : $Remark.val()
                        ...
                        if(data == 1){
                            Li.isSubmit = true;
                            parent.$.jshowtip("出库单已保存！", "success", 1,null,function(){
    ...
    <div id="contents">
        <div id="top">
            <div class="con clearfix">
                <div class="fl">
                    <a href="javascript:;" class="btn img back" rel="/Z10OutDepot/OutDepotList"><i class="icon i_back"></i>返回<b></b></a>
                </div>
            </div>
        </div>
        <div id="main">
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0" class="detail <% if (ViewData["IsDetail"]!=null){ Response.Write("readonly");}%>">
                ...
                <tr>
                    ...
                    <td class="tc">
                        <%= Html.TextBox("DateOrder", Model.Z10Order.DateOrder != null ? Model.Z10Order.DateOrder.Value.ToString("yyyy-MM-dd") : "", new { @class = "text w100"})%> ~ 
                        <%= Html.TextBox("DateShip", Model.Z10Order.DateShip != null ? Model.Z10Order.DateShip.Value.ToString("yyyy-MM-dd") : "", new { @class = "text w100" })%>
                    </td>
                    <td width="*">
                    </td>
                </tr>
