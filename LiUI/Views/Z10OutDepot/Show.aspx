    ...
    <div id="contents">
        ...
        <div id="main">
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0" class="detail <% if (ViewData["IsDetail"]!=null){ Response.Write("readonly");}%>">
                ...
                <tr>
                    <td class="tt">应收款：</td>
                    <td class="tc"><%=(Model.Z10Order.FeeShould ?? 0).ToString("0.##")%></td>
                    <td class="tt">实收款：</td>
                    <td class="tc"><%=(Model.Z10Order.FeePaid ?? 0).ToString("0.##")%></td>
                    <td width="*"></td>
                </tr>
                <tr>
                    <td class="tt">备注：</td>
                    ...
                    <td colspan="5">
                        ...
                        <table width="100%" id='oItem' class="list-table f12">
                            <tr>
                                ...
                                <th class="w100 tc">应收款</th>
                                <th class="w100 tc">实出库数量</th>
                            </tr>
