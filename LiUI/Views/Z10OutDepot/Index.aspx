...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
		...
		var controller = "/Z10OutDepot";
		var sortUrl = "<%=Model.ToSortUrl() %>";

		$(function () {
			$("#bQuery").click(function () {
				window.location.href = controller + '/OutDepotList?PageSize=' + pageSize 
            ...
            $(".xputout").click(function () {
                var id = $(this).attr("rel");
                parent.go2(controller + "/Putout/" + id+ "/?returnUrl=<%= HttpUtility.UrlEncode(Request.RawUrl) %>");
            });
            $(".xpay").click(function(){
                var id = $(this).attr("rel");
                    ...
                    <td>
                        ...
                        <div>
                          ...
                          if (finished == 0)
                          {
                              ...
                              if (stored == 0)
                                  Response.Write("<li><i class=\"icon i_putin\"></i><a href=\"javascript:;\" rel=\"" + item.OrderID + "\"  class=\"xputout\">出库</a></li>");

                              if (paid == 0)
                                  Response.Write("<li><i class=\"icon i_pay\"></i><a href=\"javascript:;\" rel=\"" + item.OrderID + "\"  class=\"xpay\">收款</a></li>");
                          }
                                %>
                            </ul>
                        </div>
    ...
    <div id="bottom">
        <%=Model.ToPagerHtml("Z10OutDepot", "OutDepotList", (int)ViewData["PageSize"])%>
    </div>
</asp:Content>
