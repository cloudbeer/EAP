<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<List<EAP.Bus.Entity.Permission>>" %>
        ...
        $(function () {
            ...
            $("#btnSaveOrder").click(function () {
                ...
                $.post(url, para, function (res) {
                    if (res == '1') {
                        window.document.location.href = "/Permission";
                    } else {
                        $.jshowtip("保存失败。");
                    }
    ...
    <div id="contents">
        <div id="top">
            <div class="con clearfix">
                <div class="fl">
                    <a href="/Permission" class="btn img"><i class="icon i_back"></i>返回<b></b></a>
                </div>
            </div>
        </div>
        <div id="main">
                        ...
                        <div id="xcontent" style="padding: 30px">
                            <%
                                if (Model.Count > 0)
                                {
                                    ...
                                    {
                            %>
                            <div id="d_<%=item.PermissionID %>" style="cursor: move; padding: 10px">
