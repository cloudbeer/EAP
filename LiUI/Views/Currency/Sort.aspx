<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<List<EAP.Bus.Entity.Currency>>" %>
        ...
        $(function () {
            ...
            $("#btnSaveOrder").click(function () {
                ...
                $.post(url, para, function (res) {
                    if (res == '1') {
                        window.document.location.href = "/Currency";
                    } else {
                        $.jshowtip("保存失败。");
                    }
    ...
    <div id="contents">
        <div id="top">
            <div class="con clearfix">
                <div class="fl">
                    <a href="/Currency" class="btn img"><i class="icon i_back"></i>返回<b></b></a>
                </div>
            </div>
        </div>
        <div id="main">
                        ...
                        <div id="xcontent" style="padding: 30px">
                            <%
                                if (Model.Count > 0)
                                {
                                    ...
                                    {
                            %>
                            <div id="<%=item.ID %>" style="cursor: move; padding: 10px">
                                <%=item.Title%></div>
                            <%
                                }
                                } %>
