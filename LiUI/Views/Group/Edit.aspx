<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<EAP.Bus.Entity.Group>" %>
    ...
    <script type="text/javascript">
        $(function () {
            $("form").submit(function () {
                ...
                if ($("#Code").val().length > 30) { $.jvalidate('Code', '您输入的文字太多。', 59); return false }
