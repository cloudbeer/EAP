...
Inherits="System.Web.Mvc.ViewPage<Zippy.Data.Collections.PaginatedList<Z01Beetle.Entity.Z01Unit>>" %>
...
<td></td></tr>
        ...
        <div id="main">
            ...
            <table cellspacing="0" cellpadding="0" border="0" rel="main" class="list-table">
                ...
                <tr rel="item">
                    <td class="tc">
                        <input type="checkbox" value="<%=item.UnitID %>" name='checkID' class="xID" />
                    </td>
					                    <td>
                        <%=item.Title%>
                    </td>
                    ...
                    <td>
                        <a href="javascript:;" rel="<%=item.UnitID %>" class="i_xedit xedit">修改</a>
                        <a href='javascript:;' rel="<%=item.UnitID %>" class="i_xdel xdel">删除</a>
                        <a href='javascript:;' rel="<%=item.UnitID %>" class="i_xdetail xdetail">详情</a>
                    </td>
                </tr>
                <%
                    }
