<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Z01Beetle.Entity.Z01Unit>" %>
        ...
        <div id="main">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="detail <% if (ViewData["IsDetail"]!=null){ Response.Write("readonly");}%>">
                ...
                <tr>
                    ...
                    <td class="tc" colspan="3">
					                        <%= Html.TextBox("DisplayOrder", Model.DisplayOrder, new { @class = "text w300" })%>
					                    </td>
                    <td>
                    </td>
                </tr>
