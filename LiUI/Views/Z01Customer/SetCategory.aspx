...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
		$(function () {
			...
			var myCustomerID = <%= ViewData["CustomerID"]%>;
			$(":checkbox").click(function () {
                $(".xCategory").hide();
				$.post("/Z01Customer/SetCategory/"+myCustomerID,{categoryID:$(this).val(),isAdd:$(this).attr("checked")},function(res){
                    $(".xCategory").show();
                ...
                <tr>
                    ...
                    <td>
                        <%
                            if (Model.Count > 0)
                            {
                                var myCategories=    ViewData["MyCategories"] as List<Z01Beetle.Entity.Z01CustomerInCategory>;
