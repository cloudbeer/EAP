...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
		...
		$(function () {
			...
			$(".xterms").click(function(){
				var id = $(this).attr("rel");
				parent.go2(controller + "/Terms/" + id + "/?returnUrl=<%= HttpUtility.UrlEncode(Request.RawUrl) %>");
			});
			...
			$(".xpay").click(function(){
				var id = $(this).attr("rel");
				parent.go2(controller + "/Pay/" + id + "/?returnUrl=<%= HttpUtility.UrlEncode(Request.RawUrl) %>");
			});
		});
    </script>
    <div id="contents">
                        ...
                        <div>
                          ...
                          if (finished == 0)
                          {
                              ...
                              if (stored == 0)
                              {
                                  ...
                                  //Response.Write("<li><i class=\"icon i_putin\"></i><a href=\"javascript:;\" rel=\"" + item.OrderID + "\"  class=\"xputin_all\">整体入库</a></li>");
                              }
    ...
    <div id="bottom">
        <%=Model.ToPagerHtml("Z10Order", "PurchaseList", ViewData["PageSize"].ToInt32())%>
    </div>
</asp:Content>
