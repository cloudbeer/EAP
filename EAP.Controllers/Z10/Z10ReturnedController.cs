...
{
    public class Z10ReturnedController : EAP.Logic.__UserController
    {
        public ActionResult ReturnedList(int? PageIndex, int? PageSize, Int64? qCustomerIDStart, Int64? qCustomerIDEnd, DateTime? qCreateDateStart, DateTime? qCreateDateEnd, int? orderCol)
        {
            if ((_crud & Zippy.SaaS.Entity.CRUD.Read) != Zippy.SaaS.Entity.CRUD.Read) return RedirectToAction("NoPermission", "Error");

            Session["ReturnUrl"] = "/Z10Returned/ReturnedList";
            ...
            hs.Add("qOrderType", (int)EAP.Logic.Z10.OrderTypes.PurchaseReturn);
            hs.Add("qIsSnap", 0);
