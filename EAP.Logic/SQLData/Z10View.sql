...
AS
SELECT     dbo.Z10Depot.DepotID, dbo.Z10Depot.TenantID, dbo.Z10DepotProduct.DepotProductID, dbo.Z01Product.ProductID, dbo.Z01Product.Title AS ProductTitle, dbo.Z10Depot.Title AS DepotTitle, 
                      ...
                      dbo.Z01Product.PriceSellOff2, dbo.Z01Product.PriceSellOff3, dbo.Z01Product.UnitID,  dbo.Z01Product.BrandID
...
CREATE VIEW [dbo].[V_OrderItemDetail]
AS
SELECT     dbo.Z10OrderItem.*, dbo.Z10Order.DeleteFlag, dbo.Z10Order.OrderType, dbo.Z10Order.OrderStatus,dbo.Z10Order.CustomerID,dbo.Z10Order.DateOrder
FROM         dbo.Z10OrderItem LEFT OUTER JOIN
                      dbo.Z10Order ON dbo.Z10OrderItem.OrderID = dbo.Z10Order.OrderID
GO
